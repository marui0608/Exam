...
class BankXlsxAdmin(object):
    list_display = ['bank_name','bank_type','bank_xlsx','bank_nums','bank_chio','bank_chios','bank_judge','bank_gap','bank_person','bank_bs']
    search_fields = ['bank_name','bank_type','bank_xlsx','bank_nums','bank_chio','bank_chios','bank_judge','bank_gap','bank_person','bank_bs']
    list_filter = ['bank_name','bank_type','bank_xlsx','bank_nums','bank_chio','bank_chios','bank_judge','bank_gap','bank_person','bank_bs']
...
class GameAdmin(object):
    list_display = ['game_name','game_nums','game_score','create_time','end_time','time_bar','game_rule','class_game','bank_game']
